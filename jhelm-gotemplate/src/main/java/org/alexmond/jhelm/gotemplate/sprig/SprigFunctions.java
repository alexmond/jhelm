...
/**
 * Bridge class for Sprig functions - delegates to SprigFunctionsRegistry for refactored
 * functions and SprigFunctionsLegacy for functions that haven't been refactored yet
 *
 * @deprecated Use SprigFunctionsRegistry.getAllFunctions() directly
 */
@Deprecated
public final class SprigFunctions {

	private SprigFunctions() {
	}
	...
	/**
	 * Get legacy functions that haven't been refactored into category-specific classes
	 * yet This includes: math, encoding, crypto, date, reflection, network functions
