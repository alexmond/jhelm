 ...
 * <p>
 * Most functions have been moved to: - StringFunctions.java (string operations) -
 * CollectionFunctions.java (list/dict operations) - LogicFunctions.java (control flow) -
 * MathFunctions.java (arithmetic) - EncodingFunctions.java (base64, hashing) -
 * CryptoFunctions.java (random, certificates) - DateFunctions.java (date/time) -
 * ReflectionFunctions.java (type inspection) - NetworkFunctions.java (DNS) -
 * SemverFunctions.java (version parsing)
 * <p>
 * Remaining functions in this class: - URL parsing utilities
 * <p>
 * NOTE: This class is intentionally minimal. Most functions are duplicates from category
 * classes and are kept only for backwards compatibility during refactoring.
 *
 * @deprecated Use category-specific classes instead. This will be removed in a future
 * version.
 */
@Deprecated
public final class SprigFunctionsLegacy {

	private SprigFunctionsLegacy() {
	}
	...
	/**
	 * URL parsing function - parses URL into components Returns map with: scheme, host,
	 * port, path, query
	 */
	...
	/**
	 * Backwards compatibility: required function NOTE: This is actually a Helm template
	...
	/**
	 * Backwards compatibility: toJson function NOTE: This is actually a Helm conversion
	 * function, kept for backwards compatibility.
	 * <p>
	 * Simplified JSON serialization - for production use, see
	 * ConversionFunctions.toJson()
