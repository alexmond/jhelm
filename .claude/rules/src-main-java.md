...
- Use `@Slf4j` for logging — never `System.out.println` (exception: CLI output in jhelm-cli)
...
- No BouncyCastle PGP type imports in jhelm-cli module — pass strings to action layer
