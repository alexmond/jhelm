...
/**
 * Template content for Helm chart scaffolding.
 * Templates are based on Helm 4.1.0 default chart structure.
 * All templates use CHARTNAME as a placeholder that gets replaced with the actual chart name.
 */
public class HelmChartTemplates {
